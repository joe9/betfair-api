...
module Network.Betfair.Types.InstructionReportErrorCode
...
data InstructionReportErrorCode = INVALID_BET_SIZE
                                | INVALID_RUNNER
                                | BET_TAKEN_OR_LAPSED
                                | BET_IN_PROGRESS
                                | RUNNER_REMOVED
...
$(deriveJSON defaultOptions {omitNothingFields = True} ''InstructionReportErrorCode)
